...
public class ParserTest {
    ...
    public void commandIsNotValid() throws Exception {
        parser.commandIsValid("pickup game");
        Assert.assertEquals(null, parser.getCommand());
    }

    @Test
    public void commandIsValid() throws Exception {
        parser.commandIsValid("pick up rectangular artifact");
        Assert.assertEquals("pick up", parser.getCommand());
    }

    @Test
    public void commandWithInvalidAttribute() {
        parser.commandIsValid("start takis");
        list.add("takis");
        Assert.assertNotEquals(list, parser.getAttributes());
    }

    @Test
    public void commandWithValidAttribute() {
        parser.commandIsValid("start game");
        list.add("game");
        Assert.assertEquals(list, parser.getAttributes());
    }

    @Test
    public void commandWithInvalidAttributes() {
        parser.commandIsValid("start game takis");
        list.add("game");
        list.add("takis");
        Assert.assertNotEquals(list, parser.getAttributes());
    }
    ...
    public void commandWithValidAttributes() {
        parser.commandIsValid("pick up key torch");
        list.add("key");
        list.add("torch");
        Assert.assertEquals(list, parser.getAttributes());
    }
    ...
    public void commandWithInvalidMultipleAttributes() {
        boolean test = parser.commandIsValid("pick up restful triangular artifact");
    ...
    public void commandWithValidMultipleAttributes() {
        parser.commandIsValid("pick up rectangular artifact triangular artifact");
